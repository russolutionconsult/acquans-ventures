...
import { ArrowRight, CheckCircle, HardHat, ShieldCheck } from 'lucide-react';
import Layout from '@/components/Layout';

const domesticServices = [
  'Residential building foundations & slabs',
  'Interlocking pavement & driveway construction',
  'Retaining walls & home fencing solutions',
  'Residential drainage & soakaway systems',
  'Home renovation & structural restoration',
  'Landscaping & decorative concrete works',
];

const industrialServices = [
  'Heavy-duty factory foundations & machine bases',
  'Industrial warehouse floor casting & finishing',
  'Massive structural concrete frame construction',
  'Large-scale drainage & culvert infrastructure',
  'Commercial site clearing & bulk earthworks',
  'Bridge & high-rise structural civil engineering',
];

export default function CivilWorks() {
  return (
    <Layout>
      <SEO title="Civil Works" />
      {/* Hero */}
        ...
        <div className="relative container mx-auto px-4 lg:px-12 text-center">
          <div className="max-w-3xl mx-auto">
            <div className="inline-flex items-center gap-2 bg-primary/20 backdrop-blur-sm text-primary-light text-xs font-bold tracking-widest uppercase px-4 py-2 rounded-full mb-6 border border-primary/30">
              <HardHat className="h-4 w-4" /> Civil Engineering
            </div>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-white leading-tight mb-6">
              Strong Foundations for <span className="text-primary-light">Industrial</span> & <span className="text-primary-light">Domestic</span> Structures
            </h1>
            <p className="text-white/80 text-lg md:text-xl leading-relaxed mb-8">
              From residential homes to massive industrial complexes, our civil works division 
              builds with precision, safety, and durability at the core.
            </p>
          </div>
        </div>
      </section>
              ...
              <div className="relative group">
                ...
                <div className="absolute bottom-8 left-8 right-8 bg-white/90 backdrop-blur-md p-6 rounded-3xl border border-white/20 shadow-xl">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <p className="text-slate-900 font-bold">Standardized Excellence</p>
                      <p className="text-slate-500 text-sm">International building codes & safety first</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="flex-1 flex flex-col gap-8">
              ...
              <div className="bg-slate-50 rounded-[2.5rem] p-10 border border-slate-100 shadow-sm hover:shadow-md transition-all">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <h2 className="text-3xl font-bold text-slate-900">Domestic Works</h2>
                </div>
                <p className="text-slate-600 mb-8 leading-relaxed">
                  We specialize in high-quality residential construction that turns your vision into a 
                  durable reality. From foundations to finishing, we ensure your home stands the test of time.
                </p>
              ...
              <div className="bg-slate-900 rounded-[2.5rem] p-10 border border-slate-800 shadow-xl text-white">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <h2 className="text-3xl font-bold">Industrial Works</h2>
                </div>
                <p className="text-slate-400 mb-8 leading-relaxed">
                  Engineered for heavy loads and extreme conditions. Our industrial civil works team 
                  handles complex infrastructure projects with strict adherence to engineering standards.
                </p>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
      ...
      <section className="py-20 bg-primary">
        <div className="container mx-auto px-4 lg:px-12 text-center">
          ...
          <p className="text-white/80 mb-10 max-w-2xl mx-auto text-lg">
            Our engineering team is ready to provide the structural expertise you need. 
